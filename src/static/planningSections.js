// static/planningSections.js
module.exports = [
  {
    sectionId: "engagement_setup_acceptance_independence",
    ...
    fields: [
      {
        ...
        required: true,
        help:
          "Choose the framework used for financial statements; ISA 210 requires an acceptable framework (GAPSME included).",
      },
      {
      ...
      },
      {
        ...
        type: "checkbox",
        label:
          "Management responsibilities acknowledged (FS prep, IC, access to information/personnel)",
        required: true,
        help:
          "Required by ISA 210 to confirm management understands its responsibilities.",
      },
      {
        ...
        required: true,
        help:
          "Documents scope, responsibilities, reporting framework, and limitations per ISA 210.",
      },
      {
        key: "engagement_type",
        type: "select",
        ...
        required: true,
        help:
          "Select appropriate action; ISA 300 emphasizes that planning and acceptance may need revisiting.",
      },
      {
        ...
        help:
          "Attach due diligence, including KYC/UBO/AML, for new client acceptance.",
      },
      {
        ...
        help:
          "Attach documentation of prior issues or changes when continuing client.",
      },
      {
      ...
      },
      {
        ...
        help:
          "Record confirmations from all team members per ISA 220 (Revised).",
      },
      {
        ...
        required: true,
        help:
          "Determine if fee dependency exceeds firm threshold (e.g., ≥15%).",
      },
      {
        ...
        help:
          "Select safeguards if dependency is high, especially for PIEs.",
      },
      {
      ...
      },
      {
        ...
        help:
          "ISA 220 (Revised) requires documentation of identified threats.",
      },
      {
      ...
      },
      {
        ...
        required: true,
        visibleIf: {
          ethical_threat_types: [
            { operator: "any", value: ["Self-review", "Familiarity", "Advocacy", "Intimidation", "Self-interest", "Other"] },
          ],
        },
      ...
      },
      {
        ...
        required: true,
        visibleIf: {
          ethical_additional_checks: [
            { operator: "any", value: ["long_tenure", "client_relationships", "management_functions", "non_audit_services"] },
          ],
        },
      ...
      },
      {
        ...
        required: true,
        help:
          "Upload register/documentation of independence compliance.",
      },
      {
      ...
      },
      {
        ...
        required: true,
        help:
          "Include EQR if required by ISQM 1 or firm policy.",
      },
      {
        key: "eqr_reviewer",
        type: "user",
      ...
      },
      {
        ...
        required: true,
        help:
          "Identify areas requiring consultation during planning.",
      },
      {
      ...
      },
      {
        ...
        required: true,
        help:
          "Upload plan evidencing partner's oversight and quality procedures.",
      },
    ],
    footer: {
      type: "markdown",
      content:
        "**Documentation Reminder:** Under **ISA 230**, audit documentation must be sufficient for an experienced auditor to understand the procedures performed, evidence obtained, and conclusions reached—*oral explanations alone are insufficient.*",
    },
  },

  {
    sectionId: "understanding_entity_environment",
    ...
    fields: [
      {
        ...
        required: true,
        help:
          "Document industry trends, regulation, economic conditions, and external factors affecting the entity (ISA 315 ¶11(a)).",
      },
      {
        key: "entity_nature_operations",
        type: "textarea",
        label:
          "Nature of the Entity (operations, structure, governance, financing, business model)",
        required: true,
        help:
          "Describe operations, governance, structure, financing, investments, and business model including IT integration (ISA 315 ¶11(b), Appendix 1).",
      },
      {
        ...
        required: true,
        help:
          "Evaluate policies for appropriateness and consistency with framework; document reasons for any changes (ISA 315 ¶11(c)).",
      },
      {
        ...
        required: true,
        help:
          "Document entity’s objectives, strategies, and related risks that could cause misstatement (ISA 315 ¶11(d)).",
      },
      {
        key: "performance_measurement",
        type: "textarea",
        label:
          "Measurement and Review of Financial Performance (internal & external)",
        required: true,
        help:
          "Describe how performance is measured internally and externally, and how pressure may create misstatement risk (ISA 315 ¶11(e), A74–A77).",
      },
      {
        ...
        required: true,
        help:
          "Assess tone at the top, ethics culture, governance oversight (ISA 315 ¶14, A77–A87).",
      },
      {
        ...
        required: true,
        help:
          "Describe how management identifies and responds to business risks relevant to financial reporting (ISA 315 ¶15–¶17).",
      },
      {
        ...
        required: true,
        help:
          "Document how internal control is monitored and deficiencies are addressed, including any internal audit function (ISA 315 ¶22–¶24).",
      },
      {
        ...
        required: true,
        help:
          "Describe transaction flows, IT and manual systems, reporting processes, journal entry controls (ISA 315 ¶18–¶19).",
      },
      {
        ...
        required: true,
        help:
          "Identify significant controls addressing risks at assertion level (ISA 315 ¶20–¶21).",
      },
      {
        ...
        required: true,
        help:
          "Understand IT environment and general IT controls relevant to the audit (Appendix 5 & 6 of ISA 315 Revised).",
      },
      {
        key: "risk_assessment_discussion",
        type: "textarea",
        label:
          "Engagement Team Discussion – Susceptibility to Misstatement (including fraud)",
        required: true,
        help:
          "Document discussion among team about susceptibility to material misstatement and fraud (ISA 315 ¶10, A21–A24).",
      },
      {
        key: "identified_risks_and_assertions",
        type: "table",
        label:
          "Identified Risks of Material Misstatement (Financial Statement & Assertion Level)",
        required: true,
        columns: [
          "Risk Description",
          "Level (FS / Assertion)",
        ...
        help:
          "List identified risks by level, related assertions, IRF tags, and relevant controls (ISA 315 ¶25, ¶26).",
      },
      {
        ...
        required: true,
        help:
          "Tick if this risk requires special audit consideration (non-routine, estimation, fraud risk) per ISA 315 ¶32.",
      },
      {
        key: "substantive_only_risk",
        type: "checkbox",
        label:
          "Does this risk require only substantive procedures? (Controls not reliable)",
        required: true,
        help:
          "Tick if substantive procedures alone are required (control risk high or controls absent) per ISA 315 ¶30.",
      },
      {
        key: "documentation_reminder",
        type: "markdown",
        content:
          "**ISA 230 Reminder:** Document sources of understanding, risk assessment procedures, identified risks and controls, team discussions, and the rationale. Documentation must be sufficient for an experienced auditor to understand the work.",
      },
    ],
  },

  {
    sectionId: "materiality_risk_summary",
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        help:
          "E.g., 5 % of performance materiality—used to accumulate misstatements.",
      },
      {
      ...
      },
      {
        ...
        help:
          "Set lower thresholds for components to address aggregation risk.",
      },
      {
        key: "documentation_reminder",
        type: "markdown",
        content:
          "**ISA 230 Documentation Reminder:** Record all judgments, thresholds, rationales, revisions, and communications with TCWG.",
      },
    ],
  },

  {
    sectionId: "fraud_gc_planning",
    ...
    fields: [
      {
        ...
        required: true,
        help:
          "Discuss where FS may be susceptible to fraud; ISA 240 (Revised) requires a heightened 'fraud lens'.",
      },
      {
        ...
        required: true,
        help:
          "ISA 240 (Revised) requires understanding of the entity's whistleblower procedures.",
      },
      {
        ...
        required: true,
        help:
          "Includes discussing risks of fraud and any past incidents with management or TCWG.",
      },
      {
        ...
        required: true,
        help:
          "ISA 240 (Revised) emphasizes considering fraud risks when determining KAMs.",
      },
      {
        ...
        required: true,
        help:
          "ISA 570 (Revised 2024) requires evaluation over at least 12 months from FS approval.",
      },
      {
        ...
        required: true,
        help:
          "Assess and corroborate management's plans to address going concern assumptions.",
      },
      {
        ...
        required: false,
        help:
          "Document assurances or support (financial or otherwise) from third parties.",
      },
      {
        ...
        help:
          "ISA 570 (Revised) requires a dedicated report section in all cases.",
      },
      {
        ...
        required: true,
        help:
          "If no uncertainty: state that GC basis is appropriate, no doubt identified, basis of conclusion. If MURGC: include reference to disclosures, conclusion and opinion unaffected.",
      },
      {
        key: "documentation_reminder",
        type: "markdown",
        content:
          "**ISA 230 Reminder:** Document fraud planning, inquiries, management’s going concern plans, and communications to support your judgments.",
      },
    ],
  },

  {
    sectionId: "risk_response_planning",
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        help:
          "Describe tests of details or analytics planned in response to this risk.",
      },
      {
      ...
      },
      {
        ...
        required: true,
        help:
          "Include unpredictable testing nature as a deterrent (ISA 330 A1).",
      },
      {
        ...
        required: true,
        help:
          "E.g. specialized staff, supervision increase, professional skepticism based on risk.",
      },
      {
        key: "documentation_reminder",
        type: "markdown",
        content:
          "**ISA 330 Documentation Reminder:** Record the risk linkages, procedure rationale, and how responses address assessed risks at assertion level.",
      },
    ],
  },

  {
    sectionId: "compliance_laws_regulations",
    title: "Section 4: Compliance with Laws & Regulations (ISA 250)",
    ...
    fields: [
      {
        ...
        required: true,
        help:
          "Describe laws/regulations affecting FS and how the entity ensures compliance (ISA 250 ¶13–17).",
      },
      {
        ...
        required: true,
        help:
          "E.g., checks for tax, pension, licensing compliance — obtain sufficient audit evidence (ISA 250 ¶13).",
      },
      {
        ...
        required: true,
        help:
          "E.g., inquiries, regulatory correspondence to identify non-compliance (ISA 250 ¶14).",
      },
      {
        ...
        required: true,
        help:
          "Required: management confirms all known non-compliance disclosed (ISA 250 ¶16).",
      },
      {
      ...
      },
      {
        ...
        help:
          "Document nature, circumstances, management/TCWG discussions, legal advice (ISA 250 ¶18–20).",
      },
      {
        key: "notify_tcwg",
        type: "checkbox",
      ...
      },
      {
        ...
        visibleIf: { non_compliance_flag: [true] },
        help:
          "If management response is unsatisfactory and risk is material, seek legal advice (ISA 250 ¶19).",
      },
      {
        key: "documentation_reminder",
        type: "markdown",
        content:
          "**ISA 230 Reminder:** Document all compliance understanding, procedures, findings, communications, and legal consultations per audit documentation standards.",
      },
    ],
  },
];
