module.exports = [
  ...
  { key: 'form-dd1', description: 'Form DD1 drafted/prepared', category: 'Post-Audit Letters & Documentation' },
  { key: 'form-dd2', description: 'Form DD2 drafted/prepared', category: 'Post-Audit Letters & Documentation' },

  { key: 'lor-drafted', description: 'Letter of Representation drafted/prepared', category: 'Post-Audit Letters & Documentation' },
  { key: 'lor-received', description: 'Signed Letter of Representation received', category: 'Post-Audit Letters & Documentation' },

  { key: 'shareholder-confirmation', description: 'Confirmation from shareholders received', category: 'Post-Audit Letters & Documentation' },

  { key: 'shareholder-draft', description: 'Draft shareholder\'s resolution', category: 'Post-Audit Letters & Documentation' },
  { key: 'shareholder-signed', description: 'Signed shareholder\'s resolution received', category: 'Post-Audit Letters & Documentation' },

  { key: 'director-draft', description: 'Draft director\'s resolution', category: 'Post-Audit Letters & Documentation' },
  { key: 'director-signed', description: 'Signed director\'s resolution received', category: 'Post-Audit Letters & Documentation' },
  ...
  { key: 'management-letter-sent', description: 'Final letter of management comments sent', category: 'Post-Audit Letters & Documentation' },
  ...
  { key: 'adjustments-approved', description: 'Adjustments approved by management', category: 'Post-Audit Letters & Documentation' },
