...
4. SECTION C: title exactly "DISCLOSURE & REGULATORY BREACHES". Fields: id (C1, C2, C3 sequential), test_id (format from test list), category (required - one of the valid categories), type, severity (regulatory or presentation), description, location (same as B), impact (NOT financial_impact), suggested_fix. Include missing disclosures, regulatory non-compliance, presentation issues. CRITICAL: A test_id that appears in Section C MUST NOT appear in Section A or Section B.
